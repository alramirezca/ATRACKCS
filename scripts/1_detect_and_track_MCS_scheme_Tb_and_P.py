...
or not a MCS can be modified. The parameterization in this notebook was 
...
pixels that do not match with the regions estimated in that time step.
6. Estimate an approximate area of those precipitation pixels, 
